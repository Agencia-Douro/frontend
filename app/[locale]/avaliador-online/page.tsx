                ...
                <div className="container pt-12 md:pt-20 lg:pt-24 xl:pt-32 pb-8 md:pb-12 lg:pb-16">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                            ...
                            <div className="border border-brown/20 divide-y divide-brown/20">
                                {/* Dados Pessoais */}
                                <div className="p-6 md:p-8 lg:p-10 space-y-4">
                                    <h3 className="body-20-medium md:heading-quatro-medium text-black mb-4">{t("personalData.title")}</h3>
                                ...
                                {/* Dados do Imóvel */}
                                <div className="p-6 md:p-8 lg:p-10 space-y-4">
                                    <h3 className="body-20-medium md:heading-quatro-medium text-black mb-4">{t("propertyData.title")}</h3>
                                ...
                                <div className="flex items-center gap-2 p-6 md:p-8 lg:p-10">
                                    <Checkbox
                                        id="modal-marketing"
