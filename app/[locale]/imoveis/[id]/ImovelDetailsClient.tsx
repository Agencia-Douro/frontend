    ...
    return (
        <>
            <section className="container pt-16">
                <div className="flex justify-between items-center py-4 gap-4 flex-wrap">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-wrap items-center gap-x-0.5 gap-y-1">
                            ...
                            <p className="body-16-medium text-brown whitespace-nowrap">{property.country && property.country !== "PT" ? `${property.region}, ${property.city}` : `${property.concelho}, ${property.distrito}`}</p>
                        </div>
                    </div>
                    <ImagensImoveis
                        property={property}
                ...
                <div className="pt-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 min-w-0">
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 body-16-medium text-brown justify-between md:justify-start w-full md:w-auto">
                        ...
                        <div className="block h-3 w-px bg-brown/30"></div>
                        <p className="whitespace-nowrap"><span className="text-brown/50">#</span>{property.reference}</p>
                    </div>
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 mt-4">
                    <div className="lg:col-span-6 flex flex-col md:flex-row gap-4">
                        <a
                            ...
                            className="flex-1"
                        >
                            <Button variant="gold" className="w-full h-full body-16-medium px-6 py-3">
                        ...
                        <a href="tel:+351919766324" className="flex-1">
                            <Button variant="gold" className="w-full h-full body-16-medium px-6 py-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M14.6667 11.28V13.28C14.6674 13.4657 14.6294 13.6494 14.5551 13.8195C14.4809 13.9897 14.3721 14.1424 14.2359 14.2679C14.0997 14.3934 13.9392 14.489 13.7642 14.5485C13.5892 14.6079 13.4036 14.6301 13.2193 14.6133C11.1586 14.3904 9.17909 13.6894 7.43268 12.5667C5.80761 11.5431 4.42396 10.1594 3.40002 8.53334C2.27335 6.77755 1.57224 4.78714 1.35335 2.71534C1.33668 2.53168 1.35868 2.34665 1.41768 2.17203C1.47668 1.99742 1.57147 1.83712 1.69604 1.70098C1.8206 1.56484 1.97226 1.45581 2.14139 1.38087C2.31052 1.30593 2.49338 1.26682 2.67868 1.26601H4.67868C4.99977 1.26286 5.31052 1.37354 5.55213 1.57668C5.79375 1.77982 5.94927 2.06161 5.99135 2.36934C6.06934 2.98394 6.21803 3.58738 6.43468 4.16668C6.51967 4.38976 6.53954 4.63193 6.49197 4.86573C6.4444 5.09953 6.33138 5.31515 6.16602 5.48734L5.31602 6.33734C6.26554 8.0069 7.65746 9.39882 9.32702 10.3483L10.177 9.49834C10.3492 9.33298 10.5648 9.21996 10.7986 9.17239C11.0324 9.12482 11.2746 9.14469 11.4977 9.22968C12.077 9.44633 12.6804 9.59502 13.295 9.67301C13.6063 9.71545 13.8909 9.87394 14.0949 10.1199C14.2988 10.3659 14.4077 10.6818 14.4 11.0053L14.6667 11.28Z" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                {t("callNow")}
                            </Button>
                        </a>
                    ...
                    <div className="lg:col-span-5 lg:col-end-13 flex gap-3">
                        <Button variant="gold" className="flex-1 min-w-0 body-16-medium px-6 py-3" onClick={handleDownloadPDF}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div className="lg:col-span-6 order-2 lg:order-1 pt-4 md:pt-5 lg:pt-6">
                        <div className="w-full">
                            <div
                                className="tiptap max-w-none wrap-break-word whitespace-pre-line"
            ...
            <Dialog open={showFilesModal} onOpenChange={setShowFilesModal}>
                <DialogContent className="w-full mr-4 md:max-w-2xl max-h-[80vh] overflow-y-auto remove-scrollbar">
                    <DialogHeader>
