    ...
    return (
        <>
            <section className="container pt-16">
                ...
                <div className="grid md:grid-cols-2 gap-4 w-full lg:w-1/2 mt-4">
                    <Link
                    ...
                    <a href="tel:+351919766324" className="grow">
                        <Button variant="gold" className="w-full body-16-medium px-6 py-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
