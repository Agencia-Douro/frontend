...
export default function Cards() {
    return (
        <div className="mt-8 flex items-center gap-4">
            <Link href={"/imoveis"} className="w-full bg-white mb-16">
                <div className="card-image-overlay h-93 relative">
                    <div className="bg-white text-black body-14-medium absolute bottom-2 right-2 py-1 px-1.5">Empreendimento</div>
                </div>
                <div className="flex flex-col gap-2 py-3 px-4">
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                        <div className="flex gap-1.5 items-center">
                            ...
                            <p className="body-14-medium">108m<sup>2</sup> área</p>
                        </div>
                        <div className="flex gap-1.5 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-brown">
                            ...
                            <p className="body-14-medium">3 casas de banho</p>
                        </div>
                        <div className="flex gap-1.5 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-brown">
                            ...
                            <p className="body-14-medium">3 quartos</p>
                        </div>
                        <div className="flex gap-1.5 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-brown">
                            ...
                            <p className="body-14-medium">2 lugares garagem</p>
                        </div>
                    </div>
                </div>
            </Link>
            <Link href={"/imoveis"} className="w-full bg-white mt-16">
                <div className="card-image-overlay h-93 relative">
                    <div className="bg-white text-black body-14-medium absolute bottom-2 right-2 py-1 px-1.5">Empreendimento</div>
                </div>
                <div className="flex flex-col gap-2 py-3 px-4">
