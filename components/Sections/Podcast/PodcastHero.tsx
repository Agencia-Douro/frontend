    ...
    return (
        <section className="relative">
            <div className="relative w-full min-h-dvh">
                ...
                <div className="relative flex flex-col justify-center min-h-dvh py-16 md:py-20 lg:py-16">
                    <div className="container px-4 w-full">
                        <div className="max-w-3xl mx-auto flex flex-col items-center text-center -mt-4 md:-mt-6">
                            <p className="body-14-medium text-white/90 uppercase tracking-wider mb-4">
                                {headerLabel}
                            </p>
                            <h1 className="text-white leading-tight heading-quatro-medium md:heading-tres-regular xl:heading-dois-regular text-balance drop-shadow-lg mb-6">
                                {title}
                            </h1>
                            <p className="text-white/95 text-3xl md:text-4xl xl:text-5xl max-w-3xl leading-relaxed text-pretty drop-shadow-md mb-8 md:mb-10 font-normal">
                                {intro}
                            </p>
                            <div className="flex flex-wrap gap-3 justify-center">
                                <Button
                                    asChild
                                    variant="outline"
                                    className="px-4 py-2.5 md:px-5 border-gold text-gold hover:bg-gold hover:text-white hover:border-gold transition-colors duration-200"
                                >
                                    <Link
            ...
            {/* Stats - abaixo da imagem, fundo claro */}
            <div className="bg-muted py-14 md:py-16 lg:py-20">
