            ...
            <div className="max-w-[616px] z-100">
                ...
                <form className="mt-12">
                    <div className="flex justify-between items-center">
                        <div className="flex">
                            <Button variant="gold" className="px-4.5">Comprar</Button>
                            <Button variant="ghost" className="px-4.5">Arrendar</Button>
                            <Button variant="ghost" className="px-4.5">Investir</Button>
                        </div>
                        <Button variant="brown" className="px-4.5">
