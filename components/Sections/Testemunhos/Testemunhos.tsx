    ...
    return (
        <section className="relative pt-12 md:pt-10 lg:pt-12 xl:pt-16 container">
            ...
            <div className="mt-4 md:mt-5 lg:mt-6 flex flex-col md:flex-row gap-4 items-center justify-center lg:justify-between">
                ...
                <Image src={Logo} alt="logo" width={178} height={81} className="hidden lg:block w-96" style={{ filter: 'saturate(100%) invert(60%) sepia(100%) saturate(1500%) hue-rotate(15deg) brightness(1) contrast(1.2)' }} />
            </div>
