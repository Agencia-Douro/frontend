                ...
                <div className="flex flex-col h-full">
                    <div className="flex flex-col flex-1 overflow-y-auto remove-scrollbar">
                        ...
                        <div className="grid grid-cols-2">
                                ...
                                <button
                                type="button"
                                onClick={() => setSelection("arrendar")}
                                className={`grow body-14-medium py-1.5 cursor-pointer ${selection === "arrendar"
                                    ? "text-white bg-gold"
                                    : "text-brown bg-muted"
                                    }`} >{t("rent")}</button>
                                <button
                                ...
                                className={`grow body-14-medium py-1.5 cursor-pointer ${selection === "empreendimentos"
                                    ? "text-white bg-gold"
                                    : "text-brown bg-muted"
                                    }`}>{t("developments")}</button>
                                 <button
                                    type="button"
