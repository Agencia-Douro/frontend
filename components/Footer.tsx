    ...
    return (
        <footer className="bg-[#1A1A1A] text-white">
            ...
            <div className="container py-8 sm:py-16">
                ...
                {/* Rodapé inferior */}
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-8 sm:mt-16 pt-4 sm:pt-8 border-t border-white/10 gap-4 sm:gap-0">
