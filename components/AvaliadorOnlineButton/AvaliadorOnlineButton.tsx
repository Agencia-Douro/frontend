    ...
    return (
        <>
            ...
            <button
                ...
                className="cursor-pointer fixed right-0 top-2/3 -translate-y-1/2 z-40 bg-gold will-change-transform text-white px-5 py-3.5 transition-all duration-300 hover:scale-105 flex items-center gap-2"
            >
