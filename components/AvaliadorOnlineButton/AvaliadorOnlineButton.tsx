    ...
    return (
        <>
            ...
            <button
                ...
                className="cursor-pointer fixed right-0 top-[40%] -translate-y-1/2 z-40 bg-brown will-change-transform text-white px-5 py-3.5 rounded-l-lg shadow-lg transition-all duration-300 hover:scale-105 flex flex-col items-center gap-2"
            >
